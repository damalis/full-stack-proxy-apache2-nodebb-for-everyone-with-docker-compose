# [full stack proxy apache2 NodeBB for everyone with docker compose](https://github.com/damalis/full-stack-proxy-apache2-nodebb-for-everyone-with-docker-compose)
...
- [proxy (apache2/httpd)](https://hub.docker.com/_/httpd)
...
```
git clone https://github.com/damalis/full-stack-proxy-apache2-nodebb-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-proxy-apache2-nodebb-for-everyone-with-docker-compose
chmod +x install.sh
...
add or remove code in the ```./proxy/conf/extra/httpd-ssl.conf.template``` file for custom proxy configurations

[https://httpd.apache.org/docs/current/howto/reverse_proxy.html](https://httpd.apache.org/docs/current/howto/reverse_proxy.html)
